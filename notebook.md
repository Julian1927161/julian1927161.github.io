...
Base structure:
AccessModifier static* returnType functionname(parameter(s) dateType parameter1, dataType parameter2)
{
...
Static: common, but optional, means that is can be used outside of a class
